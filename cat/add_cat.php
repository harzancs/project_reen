        ...
        <form action="insert_cat.php" method="POST">
            ...
            <div class="row py-2">
                <div class="col">
                    ...
                    <input type="text" name="species" class="form-control" placeholder="ป้อนชื่อแมว" maxlength="20" oninvalid="setCustomValidity('กรุณาป้อนชื่อแมว')" oninput="setCustomValidity('')" required>
                </div>
                <div class="col">
                    ...
                    <select name="cat_food" class="form-select" require>
                        ...
                        ?>
                            <option value="<?= $f['id'] ?>"><?= $f['food_type'] ?></option>
                        <?php
                        }
                        ?>
