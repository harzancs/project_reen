                    ...
                    ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="edit_cat.php?cat_id=<?php echo $customer['cat_id']; ?>" class="icon-cog fs-5 me-3 btn btn-outline-warning"><i class="bi bi-pencil-fill"></i>
                                        <a data-id="<?php echo $customer['cat_id']; ?>" href=" ?delete=<?php echo $customer['cat_id']; ?>" class="delete-btn icon-de fs-5 me-3 btn btn-outline-danger"><i class="bi bi-trash3-fill"></i></a>
                                </td>
